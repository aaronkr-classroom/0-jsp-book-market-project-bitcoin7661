...
<u1 class = "nav nav-pills">
	...
	<li class = "nav-item"><a href="<c:url value=" /editBook.jsp?" edit=delete"/>" class ="nav-link">도서 수정</a></li>
	<li class = "nav-item"><a href="<c:url value=" /editBook.jsp?" edit=update"/>" class ="nav-link">도서 삭제</a></li>
