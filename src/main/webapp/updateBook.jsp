...
<% 
	...
	if (rs.next()) {
		...
		<div class = "mb-3 row">
			...
			<div class= "col-sm-5">
			<input type = "text" name = "description" id = "description" cols="50"
			rows="2" class = "form-control" placeholder="100자 이상 적어주세요"> <%=rs.getString("b_description")%></textarea>
			</div>
		</div>
		...
		<div class = "mb-3 row">
			...
			<div class= "col-sm-5">
			<input type = "text" name = "unitInStock" id = "unitsInStock" class = "form-
			control" value = '<%=rs.getString("b_unitsInStock")%>'>
			</div>
		</div>
