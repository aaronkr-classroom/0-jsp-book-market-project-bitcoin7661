...
<div class="container py-4">
	...
	<div class="p-5 mb-4 bg-body-tertiary rounded-3">
		<div class="container-fluid py-5">
		 <h1 class="display-5 fw-bold">fmt:message key="tltle" /><h1>
	...
	<div class="text-end">
		...
		<a href="logout.jsp" class="btn btn-sm btn-success pull right"></a>
	</div>
	  ...
	  <div class="col-sm-3">
	   ...
	   <div class="mb-3 row">
	    ...
	    <div class="col-sm-5">
	     ...
	     <div class="mb-3 row">
	    	<div class=col-sm-2><fmt:message ket= "bookImage" /></label>
	    	<div class col-sm-5">
